...
<style type="text/css">
.user_main_full{background:url(../shop-images/shop-bg-top.jpg) no-repeat center bottom;}
...
<div class="user_main">
&nbsp;&nbsp;&nbsp;&nbsp;<span class="title1">注册会员</span>&emsp;&emsp;[<a class="back_home_a" href="#">返回首页</a>]&emsp;[<a class="back_home_a" href="#">登录</a>]<br /><hr />
&nbsp;&nbsp;&nbsp;&nbsp;<span class="title2">请填写您的基本信息</span>&emsp;*为必填项<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*用户名&nbsp;&nbsp;<input type="text" id="get_name" />&nbsp;&nbsp;<span class="gray"><input class="btn1" type="button" value="验证" />（用户名必须由数字、字母和下划线组成）</span>
<span class="node">恭喜您,该名称还没有被使用！</span><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*密码&nbsp;&nbsp;<input type="password" id="get_pwd" />&nbsp;&nbsp;<span class="node">（密码强度：强）</span><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*确认密码&nbsp;&nbsp;<input type="password" id="get_pwd2" /><br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*验证码&nbsp;&nbsp;<input type="text" id="get_code" /><br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已经有账号了？&nbsp;&nbsp;&nbsp;&nbsp;<a href="#">去网站首页</a>&nbsp;&nbsp;<a href="#">去商城逛逛</a>&nbsp;&nbsp;<a href="#">会员中心</a>
</div>
</div>
<div style="background-color:#0467e6">
	<div style="font-size:14px;line-height:30px; width:950px;margin:0 auto; background:url(../images/bg-flower.png) repeat top left; border-top:2px solid #AEB1AE;">
